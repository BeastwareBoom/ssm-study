...
CREATE DATABASE ssm1024 CHARACTER SET utf8 COLLATE utf8_general_ci;
# 创建admin用户，密码12345，%代表这个账户可以在任何主机登录，localhost表示只能在本机
CREATE USER 'admin'@'%' IDENTIFIED BY '12345';
# 赋予admin用户ssm1024数据库的所有权限
GRANT ALL PRIVILEGES ON ssm1024.* TO 'admin'@'%';
FLUSH PRIVILEGES;
